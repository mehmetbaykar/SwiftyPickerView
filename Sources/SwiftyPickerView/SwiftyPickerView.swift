...
open class SwiftyPickerView: UIView {
    ...
    public var toolbarDoneButtonColor: UIColor? {
        didSet {
            applyToolbarButtonItemsSettings(withAction: #selector(SwiftyPickerView.done)) { (barButtonItem) in
    ...
    public var toolbarCancelButtonColor: UIColor? {
        didSet {
            applyToolbarButtonItemsSettings(withAction: #selector(SwiftyPickerView.cancel)) { (barButtonItem) in
    ...
    */
    ...
    internal var mcPickerPopoverViewController: SwiftyPickerViewPopoverViewController?
    ...
    open class func show(data: [[String]],
        ...
        SwiftyPickerView(data:data).show(doneHandler: doneHandler, cancelHandler: cancelHandler, selectionChangedHandler: selectionChangedHandler)
    }

    open class func show(data: [[String]], doneHandler: @escaping DoneHandler) {
        SwiftyPickerView(data:data).show(doneHandler: doneHandler)
    }
    ...
    open class func showAsPopover(data: [[String]],
                                  ...
                                  cancelHandler: CancelHandler? = nil,
                                  selectionChangedHandler: SelectionChangedHandler? = nil) {
        SwiftyPickerView(data: data).showAsPopover(fromViewController: fromViewController,
    ...
    open func showAsPopover(fromViewController: UIViewController,
        ...
        mcPickerPopoverViewController = SwiftyPickerViewPopoverViewController(mcPicker: self)
    ...
    open func setToolbarItems(items: [SwiftyPickerViewBarButtonItem]) {
        toolbar.items = items
    ...
    open override func willMove(toWindow newWindow: UIWindow?) {
        ...
        if newWindow != nil {
            NotificationCenter.default.addObserver(self, selector: #selector(SwiftyPickerView.sizeViews), name: UIDevice.orientationDidChangeNotification, object: nil)
        } else {
    ...
    public func setup() {
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(SwiftyPickerView.cancel))
        tapGestureRecognizer.delegate = self
        self.addGestureRecognizer(tapGestureRecognizer)

        let fixedSpace = SwiftyPickerViewBarButtonItem.fixedSpace(width: appWindow.bounds.size.width * Constant.barButtonFixedSpacePadding)
        setToolbarItems(items: [fixedSpace, SwiftyPickerViewBarButtonItem.cancel(mcPicker: self),
                                SwiftyPickerViewBarButtonItem.flexibleSpace(), SwiftyPickerViewBarButtonItem.done(mcPicker: self), fixedSpace])
...
extension SwiftyPickerView : UIPickerViewDataSource {
...
extension SwiftyPickerView : UIPickerViewDelegate {
...
extension SwiftyPickerView : UIPopoverPresentationControllerDelegate {
...
extension SwiftyPickerView : UIGestureRecognizerDelegate {
...
extension SwiftyPickerView : UITextFieldDelegate {
    public func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        if let mcTextField = textField as? SwiftyPickerViewTextField {
